...
<template>
	<div class="py-12">
		<div class="max-w-[1200px] mx-auto px-4">
			...
			<div class="grid lg:grid-cols-8 gap-4 mb-16">
				<!-- Config panel -->
				...
				<div class="lg:col-span-6">
					<div class="bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 p-4 sticky top-24">
						<h2 class="text-lg font-semibold text-surface-900 dark:text-surface-100 mb-4">
