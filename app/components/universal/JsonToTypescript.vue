<template>
  <div>
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          <label class="text-sm font-bold text-surface-700 dark:text-surface-300">TypeScript Interface</label>
          <div class="flex gap-2">
    ...
    <div class="mt-4 flex flex-wrap items-center gap-4">
      <div class="flex items-center gap-2">
        <label class="text-xs font-bold text-surface-600 dark:text-surface-400">Interface Name:</label>
        <input
      ...
      <div class="flex items-center gap-2">
        ...
        <label for="export" class="text-xs font-bold text-surface-600 dark:text-surface-400">Export</label>
      </div>
    </div>
...
const generateTypescript = () => {
  ...
  try {
    ...
    if (typeof parsed !== 'object' || parsed === null) {
      error.value = 'Input must be a JSON object or array'
      return
    }
